...
$(function(){
    ...
    $(".v_cover").click(function(){
        ...
        $(".v_wrap").find("::after").css("opacity" , "0");
    });
    ...
    $("#specs .s_wrap .spc .s_con .head").click(function(){
        $("#specs .s_wrap .spc .s_con .head").removeClass("active");
        $("#specs .s_wrap .spc .s_con .head .btn").removeClass("close");
        
        $(this).next("#specs .s_wrap .spc .s_con .content").slideToggle();
        $(this).toggleClass("active");
        $(this).children("#specs .s_wrap .spc .s_con .head .btn").toggleClass("close");

        $("#specs .s_wrap .spc .s_con .content").not($(this).next()).slideUp();
    });
